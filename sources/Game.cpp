...
void Game::playTurn(){
     ...
     int temp_for_draw=0;
      std::cout << "it1 " << p1_.stack_size << endl;
      std::cout << "it2 " << p1_.stack_size << endl;
      std::cout << "arr1 " << p1_.arr_Cards.size() << endl;
      std::cout << "arr2 " << p1_.arr_Cards.size()<< endl;

    
       if(p1_.name_ == p2_.name_){
    std::__throw_runtime_error("not");
   }
     ...
     //if(p1_.arr_Cards.size()==1  && p2_.arr_Cards.size()== 1){
    ...
    std::cout << "last card :" << p1_card.get_value() << endl;
    std::cout << "last card :" << p2_card.get_value() << endl;
    ...
    while(p1_.stack_size != 0 && p2_.stack_size !=0){
      ...
      if(p1_.arr_Cards.size()-draw_c <= 0 || p1_.arr_Cards.size()-draw_c > 26 || p2_.arr_Cards.size()-draw_c <=0 ||p2_.arr_Cards.size()-draw_c > 26  ){
       std::cout << "siiiiiiiiiiii" << endl;
        ...
        std::cout << " aaaaaaaaaaaaaaaaaa" << endl;
        std::cout << " p1_.arr_Cards.size()" << p1_.arr_Cards.size() << endl;
        std::cout << " p2_.arr_Cards.size()" << p2_.arr_Cards.size() << endl;
        std::cout << " draw_c" << draw_c <<endl;
       ...
       Card check_p2_card=p2_.arr_Cards.at(p2_.arr_Cards.size()-draw_c);
        ...
        std::cout << "last card -> draw" << check_p1_card.get_value() << endl;
        std::cout << "last card -> draw" << check_p2_card.get_value() << endl;
